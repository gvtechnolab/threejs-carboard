...
function RightIsland(props) {
  const shape = React.useMemo(() => {
    const _shape = new THREE.Shape();
    
    // _shape.moveTo( 10, 0 );
    _shape.absarc( arcCenterX, 0, innerTrackRadius, Math.PI - arcAngle1, Math.PI + arcAngle1, true );
    _shape.absarc( -arcCenterX, 0, outerTrackRadius, -arcAngle2, arcAngle2, false );
